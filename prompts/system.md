...
- A review question must be narrow, actionable, consequential to durable memory, and attached to a concrete attributable project or profile decision. Never emit omnibus questions covering every project, identity questions already established by explicit evidence, or questions merely because some evidence is incomplete.
